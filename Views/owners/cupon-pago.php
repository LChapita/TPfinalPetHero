...
<div>
        <span class="spandex3">
            ...
            <table>
                <tr>
                    <td align:left>
                        <h3><strong>N° 0000</strong></h3>
                    </td>
                    <td class="pe">gfcbieryfcieurhdferfrgrtgrtgrtfiurhfiuerhfuhfcreuifheivfre</td>
                    <td align:right>
                        <h3> 00/00/0000</h3>
                    </td>
                </tr>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td class="pe">hgytffuyjgjuhjhhhhhhhhuyguygg</td>
                        <td rowspan="3">
                            <p class="pe">oo<span class="spandex2"></span>jujjhhb</p>
                        </td>
                        <td> importe</td>
                    </tr>
                    <tr>
                        <td><strong>00/00/0000</strong></td>
                        <td class="pe">jygyfffhfgygyg</td>
                        <td> <strong>$????????</strong></td>
                    </tr>
                </table>
            </div>
        ...
        <table>
            ...
            <tr>
                <td colspan="3" class="t">datos contables</td>
            </tr>
        </table>
        <span class="spandex4"></span>
        <table>
